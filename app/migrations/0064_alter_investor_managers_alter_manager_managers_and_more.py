# Generated by Django 4.1 on 2023-12-11 14:57
            ...
            fields=[
                ...
                ('role', models.CharField(
                    choices=[('CLIENT', 'Клієнт'), ('DRIVER', 'Водій'), ('DRIVER_MANAGER', 'Менеджер водіїв'),
                             ...
                             ('SUPPORT_MANAGER', 'Менеджер підтримки'), ('PARTNER', 'Власник'),
                             ('INVESTOR', 'Інвестор')],
                    default='CLIENT', max_length=25)),
                ('groups', models.ManyToManyField(related_name='baseuser_groups', to='auth.group')),
                ('user_permissions',
                 models.ManyToManyField(related_name='baseuser_user_permissions', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
